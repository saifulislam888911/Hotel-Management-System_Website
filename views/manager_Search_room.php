...
<div>
	...
	<table class="table table-striped" >
		...
		<tbody>
			...
			//**************************************************************************************************												
									echo '<td><a href="manager_ViewRoomInfo.php?room_no='.$row["room_no"].'" class="btn btn-primary">View</a></td>';
									
									echo '<td><a href="manager_EditRoom.php?room_no='.$row["room_no"].'" class="btn btn-success">Edit</a></td>';
									
									echo '<td><a href="manager_DeleteRoom.php?room_no='.$row["room_no"].'" class="btn btn-danger">Delete</td>';
