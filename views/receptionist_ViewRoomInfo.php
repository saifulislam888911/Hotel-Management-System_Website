...
<!--************************************************************************************************-->	
			<td align="center">
				...
				<div class="add-to-cart"><span><a href="R_BookRoom.php" class="btn btn-success" style="width:185px;font-family:consolas;margin-top:5px;">Book Now</a></span></div>
				
				<?php
				
				echo '<div class="add-to-cart"><span><a href="receptionist_EditRoom.php?room_no='.$room["room_no"].'" class="btn btn-info" style="width:185px;font-family:consolas;margin-top:5px;">Update Info</a></span></div>';
