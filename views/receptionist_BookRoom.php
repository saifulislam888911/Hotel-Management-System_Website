<?php 
	...
	include '../controllers/receptionist_CustomerController.php';
		...
		function searchCustomer()
			{
				...
				http.open("GET","receptionist_BookRoom_Search_Customer.php?sk="+search_word,true);
				http.send();
...
<!--******************************************************************************-->
	...
	<div class="center">
		...
		<form method="post" action="../controllers/receptionist_Book_Room_Controller.php" class="form-horizontal form-material">
		...
		function searchRoom()
			{
				...
				http.open("GET","receptionist_BookRoom_Search_Room.php?sk="+search_word,true);
				http.send();
