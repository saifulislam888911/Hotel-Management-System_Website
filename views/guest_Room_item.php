...
<!--************************************************************************************************ -->
	<div class="center">
				...
				<h1 Style="color:red" class="text text-center"><b><u>***ROOM INFORMATION***</b></u></h1>
		...
		<table >
			...
			<tr>
				<td align="center">
					...
					<div class="add-to-cart"><span><a href="guest_AllRoomInfo.php" class="btn btn-primary" style="width:185px;font-family:consolas;margin-top:5px;">SEE MORE ROOMS Now !</a></span></div>
					<div class="add-to-cart"><span><a href="guest_BookRoom.php" class="btn btn-success" style="width:185px;font-family:consolas;margin-top:5px;">Book Now</a></span></div>
				</td>
