	...
	<table class="table table-striped" >
		...
		<tbody>
			...
			//**************************************************************************************************												
									...
									echo '<td><a href="receptionist_EditRoom.php?room_no='.$row["room_no"].'" class="btn btn-success">Edit</a></td>';
									
									echo '<td><a href="receptionist_DeleteRoom.php?room_no='.$row["room_no"].'" class="btn btn-danger">Delete</td>';
