...
<!--************************************************************************************************-->			
			...
			<td>
				<form method="post" action="../controllers/guest_CustomerController.php" enctype="multipart/form-data" class="form-horizontal form-material">
					...
					<div class="form-group">
						...
						<select name="booked_room_no" class="form-control">
							<option selected="selected"><?php echo $customer["booked_room_no"];?></option>
						</select>
					</div>	
...
<!--*************************************************************************************************-->				
					<div class="form-group text-center">	
						<?php
							...
							echo '<a href="guest_DeleteCustomer.php?customer_id='.$customer["customer_id"].'" class="btn btn-danger">Delete Account</a>';
