...
<div>
	...
	<table class="table table-striped" >
		...
		//**************************************************************************************************	
									echo '<td><a href="manager_ViewEmployeeInfo.php?employee_id='.$row["employee_id"].'" class="btn btn-primary">View</a></td>';
									
									echo '<td><a href="manager_EditEmployee.php?employee_id='.$row["employee_id"].'" class="btn btn-success">Edit</a></td>';
								
									echo '<td><a href="manager_DeleteEmployee.php?employee_id='.$row["employee_id"].'" class="btn btn-danger">Delete</a></td>';
